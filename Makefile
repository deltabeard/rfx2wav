NAME		:= rfxplay
DESCRIPTION	:= Play sfx files generated by rfxgen
COMPANY		:= Raylib Technologies, Deltabeard
COPYRIGHT	:= Copyright (c) 2014-2020 Ramon Santamaria, Mahyar Koshkouei, et al.
LICENSE_SPDX	:= Zlib
